...
out$h2 <- as.numeric(strsplit(tmp_name[8], "-")[[1]][2])
out$ts <- as.numeric(strsplit(tmp_name[9], "-")[[1]][2])
out$num_causal <- as.numeric(strsplit(tmp_name[10], "-")[[1]][2])
out$env <- as.numeric(strsplit(tmp_name[11], "_")[[1]][2])
