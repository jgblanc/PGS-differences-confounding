...
```{r, warning=FALSE, message=FALSE}
# Read in results 
df <- fread("../plots/4PopSplit/C/q_LMM.txt")
df <- df [,3:ncol(df)]
...
# Plot Data
LLM_C <- ggplot(data = dfPlot, aes(x = L, y = avg_q)) + geom_point(size=2) + scale_x_log10() +  xlab(TeX("$L$")) + ylab("Bias") +  theme_bw(base_size = 14) + theme(legend.position = "bottom", panel.border = element_rect(colour = "black", fill=NA, size=1), legend.text = element_text(size = 10), panel.grid.minor = element_line(linetype = 'dashed'), axis.title.y = element_text(margin = margin(r = 14)), plot.margin = margin(t = 10, r = 10, b = 10, l = 10)) + scale_alpha_manual(values = c(1,1,0.65,0.65), guide = "none")+ geom_errorbar(aes(ymin = lowerci_mean, ymax = upperci_mean), width = 0.1) + ylim(c(0,1))
LLM_C
```
...
```{r, warning=FALSE, message=FALSE}
# Read in results 
df <- fread("../plots/4PopSplit/D/q_LMM.txt")
df <- df [,3:ncol(df)]
...
# Plot Data
LLM_D <- ggplot(data = dfPlot, aes(x = L, y = avg_q)) + geom_point(size=2) + scale_x_log10() +  xlab(TeX("$L$")) + ylab("Bias") +  theme_bw(base_size = 14) + theme(legend.position = "bottom", panel.border = element_rect(colour = "black", fill=NA, size=1), legend.text = element_text(size = 10), panel.grid.minor = element_line(linetype = 'dashed'), axis.title.x = element_blank(), axis.title.y = element_text(margin = margin(r = 14)), plot.margin = margin(t = 10, r = 10, b = 10, l = 10)) + scale_alpha_manual(values = c(1,1,0.65,0.65), guide = "none")+ geom_errorbar(aes(ymin = lowerci_mean, ymax = upperci_mean), width = 0.1)  + scale_y_continuous(labels = scales::number_format(accuracy = 0.01), limits = c(0,3))
...
```{r, warning=FALSE, message=FALSE}
# Read in results 
df <- fread("../plots/4PopSplit/E/q_LMM.txt")
df <- df [,3:ncol(df)]
...
# Plot Data
LLM_E <- ggplot(data = dfPlot, aes(x = L, y = avg_q)) + geom_point(size=2) + scale_x_log10() +  xlab(TeX("$L$")) + ylab("Bias") +  theme_bw(base_size = 14) + theme(legend.position = "bottom", panel.border = element_rect(colour = "black", fill=NA, size=1), legend.text = element_text(size = 10), panel.grid.minor = element_line(linetype = 'dashed'), axis.title.y = element_text(margin = margin(r = 14)), plot.margin = margin(t = 10, r = 10, b = 10, l = 10),axis.title.x = element_blank()) + scale_alpha_manual(values = c(1,1,0.65,0.65), guide = "none")+ geom_errorbar(aes(ymin = lowerci_mean, ymax = upperci_mean), width = 0.1) + ylim(c(0,4)) + scale_y_continuous(labels = scales::number_format(accuracy = 0.01), limits = c(0,4))
